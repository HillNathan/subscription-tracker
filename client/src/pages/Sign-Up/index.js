                ...
                <div className = "form-container">
                    ...
                    <form>
                        ...
                        <div className = "row">
                            ...
                            <div className = "col">
                              ...
                              <input 
                                  ...
                                  placeholder="Verify Password" value={this.state.password2} 
                        ...
                        <div className = "form-group">
                          ...
                          <input 
                              type="text" className="form-control" id="username" 
                              placeholder="Monthly Income" value={this.state.income} 
                              onChange={this.handleChange} name="income" />
                        </div>


                        <button className = "buttons" onClick = {this.handleSubmit} >Sign Up</button>
